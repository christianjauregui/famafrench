...
## Contents
To best explore `famafrench`, the 
...
`famafrench` is available via [PyPI](https://pypi.python.org/pypi/pyfinance/).  The latest version is 0.0.1 as of March 2020.  Install with pip:
...
Please see `setup.py` for specific version threshold requirements.
